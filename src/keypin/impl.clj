...
(extend-protocol t/IDuration
  java.util.List
  (duration? [this] (and (= 2 (.size this))
                      (resolve-time-unit (.get this 1))
                      (integer? (.get this 0))))
  (dur-time  [this] (.get this 0))
  (dur-unit  [this] (resolve-time-unit (.get this 1)))
  ...
  java.util.Map
  (duration? [this] (and (resolve-time-unit (.get this :unit))
                      (integer? (.get this :time))))
  (dur-time  [this] (.get this :time))
  (dur-unit  [this] (resolve-time-unit (.get this :unit)))
